...
const programTags = [
  "1–4-cü sinif", "5–8-ci sinif", "9–11-ci sinif", "General / IELTS",
...
const programDescs = [
  ...
  "Danışıq, yazı, dinləmə bacarıqları. Sınaq imtahanları.",
...
const programDescsEn = [
  ...
  "Speaking, writing, listening skills. Practice exams.",
