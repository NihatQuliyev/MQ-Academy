...
const socials = [
  ...
  { href: "https://instagram.com/mqakademiya",        Icon: IconInstagram, label: "Instagram", color: "#E1306C" },
...
const academyHrefs = ["/about", "/vision", "/careers", "/contact"];
          ...
          <div>
            ...
            <ul className="space-y-3">
              {[
                ...
                { href: "https://wa.me/994103861524", label: "010 386 15 24 (WA)" },
