      ...
      <div className="max-w-5xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-5">
          ...
          <div className="bg-white/[0.04] border border-white/10 rounded-2xl p-7 flex flex-col gap-4">
            ...
            <div className="flex items-center gap-4 bg-white/5 border border-white/10 rounded-xl px-5 py-4 flex-1">
              <div className="w-11 h-11 rounded-xl bg-orange flex items-center justify-center text-white flex-shrink-0">
            ...
            <div className="flex items-center gap-4 bg-white/5 border border-white/10 rounded-xl px-5 py-4 flex-1">
              <div className="w-11 h-11 rounded-xl bg-white/10 flex items-center justify-center text-orange flex-shrink-0">
                <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <div>
                <p className="text-[10px] text-white/40 font-semibold uppercase tracking-widest mb-1">WhatsApp</p>
                <a href="https://wa.me/994103861524" target="_blank" rel="noreferrer" className="block text-white font-semibold no-underline hover:text-orange transition-colors">010 386 15 24</a>
                <a href="https://wa.me/994558716368" target="_blank" rel="noreferrer" className="block text-white font-semibold no-underline hover:text-orange transition-colors mt-0.5">055 871 63 68</a>
              </div>
            </div>
