...
const branches = [
  {
    ...
    embedUrl: "https://maps.google.com/maps?q=İnşaatçılar+prospekti,Bakı,Azerbaijan&output=embed&z=16",
    mapsUrl: "https://www.google.com/maps/search/İnşaatçılar+prospekti+Bakı",
  },
  {
    name: "Xalqlar",
...
const contacts = [
  { icon: <PhoneIcon />,    label: "Telefon",       links: [{ value: "012 434 85 76", href: "tel:0124348576" }, { value: "010 386 15 24", href: "tel:0103861524" }, { value: "055 871 63 68", href: "tel:0558716368" }] },
  ...
  { icon: <PinIcon />,      label: "Mərkəzi ünvan", value: "İnşaatçılar prospekti, Bakı" },
];
  ...
  return (
    <>
      <section className="px-6 md:px-12 pt-20 pb-16">
        <div className="section-num">Əlaqə</div>
        <h1 className="text-3xl md:text-4xl font-extrabold leading-none tracking-tighter text-ink max-w-4xl">
          4 filial, <span className="text-orange">bir akademiya.</span>
        </h1>
        <p className="text-lg text-ink-3 mt-6 max-w-2xl leading-relaxed">
          Bakı və Abşeronda fəaliyyət göstərən filiallarımız sizə ən yaxın məkanda keyfiyyətli təhsil təklif edir.
        </p>
      </section>
      ...
      <section className="px-6 md:px-12 pb-12">
          ...
          <div className="rounded-2xl p-9 flex flex-col relative overflow-hidden" style={{ background: "#2C1A0E" }}>
            ...
            <div className="relative flex flex-col h-full">
              <h2 className="text-2xl font-semibold text-white mb-1 tracking-tight">
                Bizimlə <span className="text-orange-2">əlaqə</span>
              </h2>
              <p className="text-sm text-white/55 mb-2">İnşaatçılar filialı — mərkəzi ofisimiz</p>
        ...
        {activeIdx !== null && (
          <p className="text-xs text-center text-muted mt-3">
            Xəritə <strong>{branches[activeIdx].name}</strong> filialını göstərir ·{" "}
        ...
        <div className="mt-12 text-center">
          <p className="text-sm text-muted mb-3">Müraciət etmək üçün aşağıya daxil olun</p>
          <a
            href="#muraciet"
